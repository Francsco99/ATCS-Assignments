...
RATINGS_PATH="group-reccomandations/data/ml-latest-small/ratings.csv"
MOVIES_PATH="group-reccomandations/data/ml-latest-small/movies.csv"
...
output_path = "group-reccomandations/data/matrices/jac-constr-pearson.csv"
